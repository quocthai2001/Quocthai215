...
<link href="../css/tai-khoan/login.css" rel="stylesheet" type="text/css"/>
...
<?php
   ...
   if($_SERVER['REQUEST_METHOD'] == 'POST'){
       ...
       {
         $ten_tk = $_POST['username'];
         $mat_khau = $_POST['password'];
         $user = tai_khoan_select_by_id($ten_tk);
         if($user)
         {
            if($user['mat_khau'] == $mat_khau && $user['ten_tk'] == $ten_tk)
            {
               ...
               {
                $_SESSION['user1'] = $user;
                header("location: ../admin/hang-hoa/hang-hoa-list.php");
               }
           }
           elseif($user['mat_khau'] != $mat_khau || $user['ten_tk'] != $ten_tk)
           {
            echo '<script language="javascript">';
            echo 'alert("Nhập sai tên tài khoản hoặc mật khẩu !")';
            echo '</script>';
           }
        }
        else
 ...
 ?>
<div class="login-div">
    <a href="../trang-chinh/index.php"><div class="logo"></div></a>
    <br>
    ...
    <div class="fields">
        ...
        <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <input type="username" name="username" class="user-input" placeholder="Tài khoản">
        </div>
        <div class="password">
        <svg class="svg-icon" viewBox="0 0 20 20">
    ...
    <button class="signin-button" name="submit" type="submit">Xác nhận</button>
    <div class="link">
        <a href="../tai-khoan/dang-ky.php">Đăng ký</a>
    </div>
    </form>
</div>
</body>

...
<link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;700&display=swap" rel="stylesheet"/>
    ...
    <link href="../css/tai-khoan/danh-sach.css" rel="stylesheet" type="text/css"/>
...
<?php
        session_start();
		require_once ('../admin/class/tai-khoan.php');
        
        extract($_REQUEST);
        if(array_key_exists('submit',$_REQUEST)){
            tai_khoan_update($ten_tk,$mat_khau,$ho_ten,$dia_chi);
            $_SESSION['user'] = tai_khoan_select_by_id($ten_tk);
        ...
        {
            header('Location: ../tai-khoan/thong-tin-tk-admin.php');
        }
        else{
		...
		if(array_key_exists('logout',$_REQUEST)){
			header('location: ../tai-khoan/logout.php');
		}
	?>
<div class="login-div">
    ...
    <br> -->
    <form method="post">
    <div class="title" style="margin-top:40px;">Thông tin tài khoản</div>
    <div class="fields">
        <div class="username">
        <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <input type="text" class="user-input" placeholder="Tài khoản" name="ten_tk" value="<?php echo $ten_tk;?>">
        </div>
        <div class="fullname">
        <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <input type="text" class="pass-input" placeholder="Họ tên" name="ho_ten" value="<?php echo $ho_ten?>">
        </div>
        <div class="password">
        <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <input type="text" class="repass-input" placeholder="Mật khẩu" name="mat_khau" value="<?php echo $mat_khau?>">
        </div>
        <div class="diachi">
        <svg class="svg-icon" viewBox="0 0 20 20">
            ...
            <input type="text" class="repass-input" placeholder="Địa chỉ" name="dia_chi" value="<?php echo $dia_chi?>">
        </div>
    </div>
    <button class="signin-button" name="submit" type="submit">Cập nhật</button>

    <a href="../tai-khoan/logout.php"><button class="logout-button" name="logout">Đăng xuất</button></a>
    </form>
</div>
</body>
</html>

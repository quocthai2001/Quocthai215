...
<body>
    ...
    <div class="container" style="margin-top: 50px;">
        <img src="../css/trang-chinh/img/bao-hanh.png" style="width:800px;height:400px;text-align:center;margin-left:180px"><br><br>
        <div class="content">
            <div class="step0">
                    <p style="color:red;font-size:30px"><b>I. CÁC BƯỚC BẢO HÀNH SẢN PHẨM</b></p>
                    <p style="font-size:20px;"><b>TBT không hỗ trợ bảo hành tận nhà, quý khách có nhu cầu bảo hành vui lòng liên hệ với TBT.</b></p>
                    <div class="step1">
                        <div class="title-big" style="cursor:pointer" id="action1" onclick="myFunction(this)">
                            <h3 style="color:red;">Bước 1</h3>
                        </div>
                        <div class="content-small">
                            <p>Khi có nhu cầu bảo hành sản phẩm, khách hàng vui lòng liên hệ XGEAR qua các hình thức sau :</p>
                    ...
                    <div class="step2">
                        ...
                        <div class="content-small">
                            ...
                            <p>Nhân viên TBT sẽ tiếp nhận thông tin và phản hồi thời gian xử lý với khách hàng, theo chính sách từng sản phẩm.</p>
                        </div>
                    </div>
                    <hr>
                   <div class="step3">
            ...
            <div class="dieu-kien">
                ...
                <div class="dieu-kien-2">
                    <div class="truoc">
                        ...
                        <ul style="margin-left:40px;">
                            <li>Các sản phẩm, thiết bị do TBT cung cấp ( dựa trên hóa đơn bán hàng, tem hoặc phiếu bảo hành, serial number v.v…. ) .</li>
                            <li>Đối với các sản phẩm, thiết bị được cấp hiếu bảo hành (PBH), khách hàng phải xuất trình PBH và có đầy đủ tem bảo hành của TBT(nếu thiết bị không cấp PBH thì phải còn nguyên tem của TBT) và phải còn trong thời hạn bảo hành.</li>
            ...
            <div class="chinh-sach">
                ...
                <p><b>KHÔNG ÁP DỤNG ĐỐI VỚI TRƯỜNG HỢP CẢM TÍNH NHƯ : ” TÔI KHÔNG THÍCH MUA NỮA, TÔI KHÔNG THÍCH SẢN PHẨM NÀY NỮA …”</b></p>
                    ...
                    <p> – Phí 2%/ trên hóa đơn sản phẩm trả của TBT : sản phẩm còn trong thời hạn đổi trả và máy chưa qua sử dụng .</p>
                    <p> – Phí 5%/ trên hóa đơn sản phẩm trả của TBT: sản phẩm còn trong thời hạn đổi trả và máy đã qua sử dụng.</p>
                    <p> – Phí 10% / trên hóa đơn sản phẩm trả của TBT ( từ ngày thứ 8 đến ngày thứ 12 ) . Bao gồm cả máy chưa qua sử dụng hoặc đã qua sử dụng .</p>
                    <p> – Phí 20% / trên hóa đơn sản phẩm trả của TBT ( từ ngày thứ 13 đến ngày thứ 20 ) . Bao gồm cả máy chưa qua sử dụng hoặc đã qua sử dụng .</p>
                    <p> – Kể từ ngày giao hàng , quá thời hạn 20 ngày sản phẩm đã mua sẽ không được áp dụng chính sách trả hàng của TBT .</p>
                    <p style="color:#66CC33"><b>LƯU Ý – YÊU CẦU VỀ TRẢ HÀNG: Sản phẩm phải còn nguyên vẹn,  không bị lỗi, không bị trầy xước . Tem/nhãn trên máy còn nguyên vẹn . 
                        Bắt buộc phải đầy đủ các giấy tờ – phụ kiện kèm theo trong thùng máy và chứng từ mà TBT đã xuất như lúc khách hàng nhận hàng ( bao gồm cả quà tặng ). 
                        TBT sẽ hoàn tiền trễ nhất trong vòng 48h dưới hình thức tiền mặt hoặc chuyển khoản theo yêu cầu của khách hàng. 
                        TBT sẽ không áp dụng chính sách trả hàng nếu như sản phẩm không đáp ứng đầy đủ các yêu cầu trên .</b></p>
                </div>
            </div>
        </div>
    </div>

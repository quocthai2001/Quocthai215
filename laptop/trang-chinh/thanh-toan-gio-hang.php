...
">
                <div class="chuyen">
                    <p><i style="font-size:24px"></i> <span>
                        <a href="index.php" style="color:black;text-decoration:none;">TRANG CHỦ </a></span> / THANH TOÁN</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <input type="text" class="form-control" id="" name="ten_tk" value="<?=$ten_tk?>" hidden>
            <tr>
            ...
            <tr>
                ...
                <textarea class="form-control" rows="5" id="" name = "ghi_chu" placeholder="Ghi chú của bạn là ..."></textarea>
                </div>
            </tr>
        </table>
        </div>
            ...
            <thead>
                ...
                <tr>
                    <td colspan="2"><i>Quý khách vui lòng kiểm tra lại thông tin giao hàng và thông tin đơn hàng để tiến hành đặt hàng. Chúc quý khách ngày mới tốt lành !</i></td>
                </tr>
                <tr>
            ...
            <?php
                require_once ('../admin/class/hoa-don.php');
                ...
                try {
                    ...
                    $sql = "INSERT INTO hoa_don(ngay_mua,ghi_chu,ma_tk) 
                            VALUES ('".$ngaymua."','".$ghi_chu."','".$ma_tk."')";
                    $conn->exec($sql);
                    ...
                    foreach($items as $item){
                        extract($item);
                        $sql = "INSERT INTO hoa_don_chi_tiet(ma_hd,ma_sp,so_luong,don_gia) VALUES ('".$ma_hd."','".$ma_sp."','".$sl."','".$price."')";
                        $conn->exec($sql);

...
<body>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="row">
            <div class="col-md-7" style="padding-left: 0px;">
                <div class="chuyen">
                    <p><span><a href="index.php" style="color: black">TRANG CHỦ</a> </span><a href="danh-sach-sp.php" style="color: black"> / SẢN PHẨM</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
		    ...
		    <div class="col-md-9">
				<?php			
                     if(isset($_POST['range']) && !empty($_POST['price1']) && !empty($_POST['price2']))
                     {
                        $conn = mysqli_connect('localhost','root','','laptop');	
                        $price1 = $_POST['price1'];
                        $price2 = $_POST['price2'];
                        $result = mysqli_query($conn,"SELECT * FROM san_pham WHERE don_gia BETWEEN $price1 AND $price2");
                ?>
            <?php 		 
	        ...
	        ?>		
			 		<div class="sanpham">
                    <a href="../trang-chinh/chi-tiet-sp.php?ma_sp=<?=$value['ma_sp']?>">
                    <span class="chi-tiet" style="margin-left: 10px">CHI TIẾT</span></a>
                    <a href="chi-tiet-sp.php?ma_sp=<?=$value['ma_sp']?>">
                    <img  src="../css/danh-sach-sp/img/<?=$value['hinh']?>" alt="" style="height:230px;width:250px;"></a>
					<div class="glow-wrap">
                       <i class="glow"></i>
                    </div>
                    <div class="text">
                        ...
                        <div class="price" style="display:inline;color:red;border-radius:15%">
                            <span><b><?=number_format($value['don_gia'])?> <u>đ</u></b></span>
                        </div>
                    </div>
                </div>
              <?php	} }	?>

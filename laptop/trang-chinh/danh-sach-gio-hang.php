            ...
            <div class="col-md-7" style="padding-left: 0px;">
                <div class="chuyen">
                    <p><i style="font-size:24px"></i> <span>
                        <a href="index.php" style="color:black;text-decoration:none;">TRANG CHỦ </a></span> / GIỎ HÀNG</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-7">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><img src="../css/danh-sach-sp/img/<?=$hinh?>" alt="" style="width:150px;"></td>
                    <td><?=number_format($price) ?> <sup>đ</sup></td>
                    <td><input class="form-control" type="number" name='sl[<?=$ma_sp?>]' value="<?=$sl ?>" style="width:50px;"></td>
                    <td><?php number_format($price*$sl);
                            $total += ($price *$sl);
                    ?></td>
                    <td><a onclick="return confirm('Bạn muốn bỏ sản phẩm này khỏi giỏ hàng ?')" style = "color:black;" href="xoa-gio-hang.php?ma_sp=<?=$ma_sp?>"><i class="fa fa-times-circle" aria-hidden="true"></i></a></td>
                </tr>
                        <?php 
						}
					}else
            ...
            <button class = "btn btn-info" name="donmua"><a style = "color:#fff;text-decoration:none;" href="don-mua.php">Các sản phẩm đã mua</a></button>
            </form>
        </div>
            ...
            <table class="table">
                ...
                <tr>
                    <td>Tổng tiền</td>
                    <td style = "text-align:right;"><?=number_format($total);
                    ?> <sup>đ</sup></td>
                </tr>
                <tr>
                    <td>Giao hàng</td>
